...
func InitHealthChecker(config Config) *CompositeChecker{
	//parse the config
	//create health checker
	if(config.HealthChecker.Name == "riak-cs") {
		...
		riakChecker := NewRiakHealthChecker(riak_pidfile, riak_admin_program, config.ExternalIp)
